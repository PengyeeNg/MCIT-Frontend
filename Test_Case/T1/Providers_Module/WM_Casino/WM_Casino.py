...
class ProvidersWMModule(Base_Setup.BSetup):

    def test_TC_Providers_WM_01_Enter_Game_01(self):
        ...
        ProvidersActions.Navigate_to_WM_Casino(self)
        ...
        for i in range(1, 2, 1):
            ...
            print("<li>" + "Click on WM Casino Game in the list: " + game_title + "</li>" + "<br>")
            for j in range(1, 5, 1):
    ...
    def test_TC_Providers_WM_02_Quick_Transfer_01(self):
