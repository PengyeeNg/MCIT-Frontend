...
class ProvidersIGSModule(Base_Setup.BSetup):

    def test_TC_Providers_IGS_01_Enter_Game_01(self):
        ...
        ProvidersActions.Navigate_to_IGS(self)
        ...
        for i in range(1, 13, 1):
            ...
            print("<li>" + "Click on IGS Game in the list: " + game_title + "</li>" + "<br>")
    ...
    def test_TC_Providers_IGS_01_Enter_Game_02(self):
        print("<b> Expected Results: Able to enter game page. </b>" + "<br>")
        LoginpageActions.Login_to_Mainpage(self)
        MainpageActions.Access_to_Providers_Page(self)
        ProvidersActions.Navigate_to_IGS(self)
    ...
    def test_TC_Providers_IGS_01_Enter_Game_03(self):
        print("<b> Expected Results: Able to enter game page. </b>" + "<br>")
        LoginpageActions.Login_to_Mainpage(self)
        MainpageActions.Access_to_Providers_Page(self)
        ProvidersActions.Navigate_to_IGS(self)
    ...
    def test_TC_Providers_IGS_01_Enter_Game_04(self):
        print("<b> Expected Results: Able to enter game page. </b>" + "<br>")
        LoginpageActions.Login_to_Mainpage(self)
        MainpageActions.Access_to_Providers_Page(self)
        ProvidersActions.Navigate_to_IGS(self)
    ...
    def test_TC_Providers_IGS_01_Enter_Game_05(self):
        print("<b> Expected Results: Able to enter game page. </b>" + "<br>")
        LoginpageActions.Login_to_Mainpage(self)
        MainpageActions.Access_to_Providers_Page(self)
        ProvidersActions.Navigate_to_IGS(self)
    ...
    def test_TC_Providers_IGS_02_Quick_Transfer_01(self):
    ...
    def test_TC_Providers_IGS_02_Quick_Transfer_02(self):
        print("<b> Expected Results: Able to perform quick transfer. </b>" + "<br>")
        LoginpageActions.Login_to_Mainpage(self)
        MainpageActions.Access_to_Providers_Page(self)
        ProvidersActions.Navigate_to_IGS(self)
    ...
    def test_TC_Providers_IGS_02_Quick_Transfer_03(self):
        print("<b> Expected Results: Able to perform quick transfer. </b>" + "<br>")
        LoginpageActions.Login_to_Mainpage(self)
        MainpageActions.Access_to_Providers_Page(self)
        ProvidersActions.Navigate_to_IGS(self)
    ...
    def test_TC_Providers_IGS_02_Quick_Transfer_04(self):
        print("<b> Expected Results: Able to perform quick transfer. </b>" + "<br>")
        LoginpageActions.Login_to_Mainpage(self)
        MainpageActions.Access_to_Providers_Page(self)
        ProvidersActions.Navigate_to_IGS(self)
    ...
    def test_TC_Providers_IGS_02_Quick_Transfer_05(self):
        print("<b> Expected Results: Able to perform quick transfer. </b>" + "<br>")
        LoginpageActions.Login_to_Mainpage(self)
        MainpageActions.Access_to_Providers_Page(self)
        ProvidersActions.Navigate_to_IGS(self)
