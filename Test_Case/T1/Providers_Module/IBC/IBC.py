...
class ProvidersIBCModule(Base_Setup.BSetup):

    def test_TC_Providers_IBC_01_Enter_Game_01(self):
        ...
        ProvidersActions.Navigate_to_IBC(self)
        ...
        for i in range(1, 2, 1):
            ...
            print("<li>" + "Click on IBC Game in the list: " + game_title + "</li>" + "<br>")
    ...
    def test_TC_Providers_IBC_02_Quick_Transfer_01(self):
