...
class ProvidersM8Module(Base_Setup.BSetup):

    def test_TC_Providers_M8_01_Enter_Game_01(self):
        ...
        ProvidersActions.Navigate_to_M8_Sports(self)
        ...
        for i in range(1, 2, 1):
            ...
            print("<li>" + "Click on M8 Sports Game in the list: " + game_title + "</li>" + "<br>")
    ...
    def test_TC_Providers_M8_02_Quick_Transfer_01(self):
