...
class ProvidersEVOModule(Base_Setup.BSetup):

    def test_TC_Providers_EVO_01_Enter_Game_01(self):
        ...
        for i in range(1, 2, 1):
            ...
            print("<li>" + "Click on EVO Game in the list: " + game_title + "</li>" + "<br>")
    ...
    def test_TC_Providers_EVO_02_Quick_Transfer_01(self):
